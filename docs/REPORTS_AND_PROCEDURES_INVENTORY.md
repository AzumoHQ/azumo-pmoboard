...
| 12 | Trends | Snapshot Trends | Neon `pmo_snapshots` | Connected | Snapshot date/time, metrics, reports payloads | Keep multiple raw snapshots but show one summary per month in Trends. Comparisons/deltas live here, not in Reports. |
